...
I built this analysis because Kenya's 2022 Digital Credit Provider (DCP) framework created comparable, disclosed pricing data across the lenders MSME owners actually use. That disclosure is only useful if someone turns it into a usable comparison. This project does that by benchmarking five active digital lenders (4G Capital, Pezesha, Tala, Zenka, and bank-backed KCB M-Pesa) on unit economics, funding structure, and regulatory adaptation, anchored to December 2023 data, with a 2025 forward-look testing whether the analysis held up.
...
The analysis is anchored to December 2023, the most recent period with comparable, dated data across all five players. Anything outside that window is dated explicitly wherever it appears, and 2025 developments are kept in a separate section rather than blended into the primary analysis so that the original December 2023 thesis can be checked against what actually happened next, rather than rewritten with hindsight.
...
4G Capital, on the strength of three factors:
 ...
 - a fully closed and diversified local-currency debt structure
 -  a regulatory-adaptation profile that strengthens ras CBK oversight intensifies.
 ...
 **Lisa Uwonkunda**
 ...
 Email: lisa.uwonkunda@gmail.com
